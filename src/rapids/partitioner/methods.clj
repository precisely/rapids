...
(declare partition-body partition-expr partition-fncall-expr
  ...
  partition-vector-expr partition-map-expr partition-map-expr
  partition-java-interop-expr partition-java-new-expr
  partition-suspend-expr partition-flow-expr partition-callcc-expr
  partition-case-expr partition-case*-expr partition-binding-expr partition-map!-expr)
...
(defn partition-expr
  ...
  (letfn [(attempt-partitioning []
            (cond
              ...
              (set? expr) (partition-map-expr expr partition-addr address params)
...
(defn partition-special-expr
  ...
  (case op
    ...
    set! (partition-map!-expr expr partition-addr address params)
...
(defn partition-map!-expr [expr partition-addr address params]
